...
var HeaderGroupCellComp = ({ ctrl }) => {
  ...
  const reactUserComp = userCompDetails?.componentFromFramework;
  const UserCompClass = userCompDetails?.componentClass;
  return /* @__PURE__ */ import_react9.default.createElement("div", { ref: setRef2, style: userStyles, className, role: "columnheader", "aria-expanded": ariaExpanded }, /* @__PURE__ */ import_react9.default.createElement("div", { ref: eHeaderCompWrapper, className: "ag-header-cell-comp-wrapper", role: "presentation" }, reactUserComp ? userCompStateless ? /* @__PURE__ */ import_react9.default.createElement(UserCompClass, { ...userCompDetails.params }) : /* @__PURE__ */ import_react9.default.createElement(UserCompClass, { ...userCompDetails.params, ref: userCompRef }) : null), /* @__PURE__ */ import_react9.default.createElement("div", { ref: eResize, "aria-hidden": resizableAriaHidden, className: resizableClassName }));
};
var headerGroupCellComp_default = (0, import_react9.memo)(HeaderGroupCellComp);
var HeaderRowComp = ({ ctrl }) => {
  const { gos, context } = (0, import_react10.useContext)(BeansContext);
  const { topOffset, rowHeight } = (0, import_react10.useMemo)(() => ctrl.getTopAndHeight(), []);
  const tabIndex = (0, import_react10.useMemo)(() => gos.get("tabIndex"), []);
  const [ariaRowIndex, setAriaRowIndex] = (0, import_react10.useState)(() => ctrl.getAriaRowIndex());
...
var HeaderRowContainerComp = ({ pinned }) => {
  ...
  return pinnedLeft ? /* @__PURE__ */ import_react11.default.createElement("div", { ref: setRef2, className: "ag-pinned-left-header " + className, "aria-hidden": !displayed, role: "rowgroup" }, insertRowsJsx()) : pinnedRight ? /* @__PURE__ */ import_react11.default.createElement("div", { ref: setRef2, className: "ag-pinned-right-header " + className, "aria-hidden": !displayed, role: "rowgroup" }, insertRowsJsx()) : centre ? /* @__PURE__ */ import_react11.default.createElement("div", { ref: setRef2, className: "ag-header-viewport " + className, role: "rowgroup", tabIndex: -1 }, /* @__PURE__ */ import_react11.default.createElement("div", { ref: eCenterContainer, className: "ag-header-container", role: "presentation" }, insertRowsJsx())) : null;
};
...
var PopupEditorComp = (props) => {
  ...
  const beans = (0, import_react15.useContext)(BeansContext);
...
var jsxEditorProxy = (editDetails, CellEditorClass, setRef2) => {
  ...
  return /* @__PURE__ */ import_react16.default.createElement(
    ...
    isStateless ? /* @__PURE__ */ import_react16.default.createElement(CellEditorClass, { ...props }) : /* @__PURE__ */ import_react16.default.createElement(CellEditorClass, { ...props, ref: (ref) => compProxy.setRef(ref) })
  );
};
var jsxEditor = (editDetails, CellEditorClass, setRef2) => {
  const newFormat = editDetails.compProxy;
  return newFormat ? jsxEditorProxy(editDetails, CellEditorClass, setRef2) : /* @__PURE__ */ import_react16.default.createElement(CellEditorClass, { ...editDetails.compDetails.params, ref: setRef2 });
};
var jsxEditValue = (editDetails, setCellEditorRef, eGui, cellCtrl, jsEditorComp) => {
  ...
  return reactInlineEditor ? jsxEditor(editDetails, CellEditorClass, setCellEditorRef) : reactPopupEditor ? /* @__PURE__ */ import_react16.default.createElement(
  ...
  ) : jsPopupEditor && jsEditorComp ? /* @__PURE__ */ import_react16.default.createElement(popupEditorComp_default, { editDetails, cellCtrl, eParentCell: eGui, jsChildComp: jsEditorComp }) : null;
};
...
var useJsCellRenderer = (showDetails, showTools, eCellValue, cellValueVersion, jsCellRendererRef, eGui) => {
  ...
  const destroyCellRenderer = (0, import_react17.useCallback)(() => {
...
var SkeletonCellRenderer = ({
  ...
  const jsCellRendererRef = (0, import_react18.useRef)();
  const renderDetails = (0, import_react18.useMemo)(() => {
  ...
  if (renderDetails?.compDetails?.componentFromFramework) {
    ...
    return /* @__PURE__ */ import_react18.default.createElement(CellRendererClass, { ...renderDetails.compDetails.params });
  }
...
var CellComp = ({
  ...
  const beans = (0, import_react19.useContext)(BeansContext);
  const { context } = beans;
  const {
  ...
  const eWrapper = (0, import_react19.useRef)(null);
  ...
  const rowDragCompRef = (0, import_react19.useRef)();
  ...
  const cellValueClass = (0, import_react19.useMemo)(() => {
  ...
  const init = (0, import_react19.useCallback)(() => {
  ...
  const setGuiRef = (0, import_react19.useCallback)((ref) => {
    eGui.current = ref;
    init();
  }, []);
  const setWrapperRef = (0, import_react19.useCallback)((ref) => {
  ...
  const valueOrCellComp = () => {
    ...
    if (compDetails.componentFromFramework) {
      ...
      return /* @__PURE__ */ import_react19.default.createElement(import_react19.Suspense, { fallback: /* @__PURE__ */ import_react19.default.createElement(SkeletonCellRenderer, { cellCtrl, parent: eGui }) }, reactCellRendererStateless ? /* @__PURE__ */ import_react19.default.createElement(CellRendererClass, { ...compDetails.params, key: renderKey }) : /* @__PURE__ */ import_react19.default.createElement(CellRendererClass, { ...compDetails.params, key: renderKey, ref: cellRendererRef }));
    }
  };
  const showCellOrEditor = () => {
    const showCellValue = () => {
      ...
      return showCellWrapper ? /* @__PURE__ */ import_react19.default.createElement("span", { role: "presentation", id: `cell-${instanceId}`, className: cellValueClass, ref: setCellValueRef }, valueOrCellComp()) : valueOrCellComp();
    };
    const showEditValue = (details) => jsxEditValue(details, setCellEditorRef, eGui.current, cellCtrl, jsEditorComp);
    if (editDetails != null) {
      if (editDetails.popup) {
        return /* @__PURE__ */ import_react19.default.createElement(import_react19.default.Fragment, null, showCellValue(), showEditValue(editDetails));
      }
      return showEditValue(editDetails);
    }
    return showCellValue();
  };
  const renderCell = () => /* @__PURE__ */ import_react19.default.createElement("div", { ref: setGuiRef, style: userStyles, role: cellAriaRole, "col-id": colIdSanitised }, showCellWrapper ? /* @__PURE__ */ import_react19.default.createElement("div", { className: "ag-cell-wrapper", role: "presentation", ref: setCellWrapperRef }, showCellOrEditor()) : showCellOrEditor());
  if (cellCtrl.isCellSpanning()) {
    return /* @__PURE__ */ import_react19.default.createElement("div", { ref: setWrapperRef, className: "ag-spanned-cell-wrapper", role: "presentation" }, renderCell());
  }
  return renderCell();
};
...
var RowComp = ({ rowCtrl, containerType }) => {
  ...
  const showCellsJsx = () => cellCtrlsMerged?.map((cellCtrl) => /* @__PURE__ */ import_react20.default.createElement(
    cellComp_default,
    {
      cellCtrl,
  ...
  const showFullWidthFrameworkJsx = () => {
    ...
    return reactFullWidthCellRendererStateless ? /* @__PURE__ */ import_react20.default.createElement(FullWidthComp, { ...fullWidthCompDetails.params }) : /* @__PURE__ */ import_react20.default.createElement(FullWidthComp, { ...fullWidthCompDetails.params, ref: fullWidthCompRef });
  };
...
var RowContainerComp = ({ name }) => {
  const { context, gos } = (0, import_react21.useContext)(BeansContext);
  const containerOptions = (0, import_react21.useMemo)(() => (0, import_ag_grid_community18._getRowContainerOptions)(name), [name]);
  const eViewport = (0, import_react21.useRef)(null);
  const eContainer = (0, import_react21.useRef)(null);
  const eSpanContainer = (0, import_react21.useRef)(null);
  const rowCtrlsRef = (0, import_react21.useRef)([]);
  const prevRowCtrlsRef = (0, import_react21.useRef)([]);
  const [rowCtrlsOrdered, setRowCtrlsOrdered] = (0, import_react21.useState)(() => []);
  const isSpanning = !!gos.get("enableCellSpan") && !!containerOptions.getSpannedRowCtrls;
  const spannedRowCtrlsRef = (0, import_react21.useRef)([]);
  const prevSpannedRowCtrlsRef = (0, import_react21.useRef)([]);
  const [spannedRowCtrlsOrdered, setSpannedRowCtrlsOrdered] = (0, import_react21.useState)(() => []);
  const domOrderRef = (0, import_react21.useRef)(false);
  const rowContainerCtrlRef = (0, import_react21.useRef)();
  const viewportClasses = (0, import_react21.useMemo)(() => classesList("ag-viewport", (0, import_ag_grid_community18._getRowViewportClass)(name)), [name]);
  const containerClasses = (0, import_react21.useMemo)(() => classesList((0, import_ag_grid_community18._getRowContainerClass)(name)), [name]);
  const spanClasses = (0, import_react21.useMemo)(() => classesList("ag-spanning-container", (0, import_ag_grid_community18._getRowSpanContainerClass)(name)), [name]);
  ...
  const areElementsReady = (0, import_react21.useCallback)(() => {
  ...
  const areElementsRemoved = (0, import_react21.useCallback)(() => {
    return eViewport.current == null && eContainer.current == null && eSpanContainer.current == null;
  }, []);
  const setRef2 = (0, import_react21.useCallback)(() => {
  ...
  const setContainerRef = (0, import_react21.useCallback)(
    (e) => {
  ...
  const setSpanContainerRef = (0, import_react21.useCallback)(
    (e) => {
  ...
  const setViewportRef = (0, import_react21.useCallback)(
    (e) => {
      eViewport.current = e;
      setRef2();
    },
  ...
  const buildContainer = () => /* @__PURE__ */ import_react21.default.createElement(
    "div",
    {
    ...
    rowCtrlsOrdered.map((rowCtrl) => /* @__PURE__ */ import_react21.default.createElement(rowComp_default, { rowCtrl, containerType: containerOptions.type, key: rowCtrl.instanceId }))
  );
  if (!shouldRenderViewport) {
    return buildContainer();
  }
  const buildSpanContainer = () => /* @__PURE__ */ import_react21.default.createElement("div", { className: spanClasses, ref: setSpanContainerRef, role: "presentation" }, spannedRowCtrlsOrdered.map((rowCtrl) => /* @__PURE__ */ import_react21.default.createElement(rowComp_default, { rowCtrl, containerType: containerOptions.type, key: rowCtrl.instanceId })));
  return /* @__PURE__ */ import_react21.default.createElement("div", { className: viewportClasses, ref: setViewportRef, role: "rowgroup" }, buildContainer(), isSpanning ? buildSpanContainer() : null);
};
var rowContainerComp_default = (0, import_react21.memo)(RowContainerComp);
var GridBodyComp = () => {
  const beans = (0, import_react22.useContext)(BeansContext);
  const { context, overlays } = beans;
  const [rowAnimationClass, setRowAnimationClass] = (0, import_react22.useState)("");
  const [topHeight, setTopHeight] = (0, import_react22.useState)(0);
  const [bottomHeight, setBottomHeight] = (0, import_react22.useState)(0);
  const [stickyTopHeight, setStickyTopHeight] = (0, import_react22.useState)("0px");
  const [stickyTopTop, setStickyTopTop] = (0, import_react22.useState)("0px");
  const [stickyTopWidth, setStickyTopWidth] = (0, import_react22.useState)("100%");
  const [stickyBottomHeight, setStickyBottomHeight] = (0, import_react22.useState)("0px");
  const [stickyBottomBottom, setStickyBottomBottom] = (0, import_react22.useState)("0px");
  const [stickyBottomWidth, setStickyBottomWidth] = (0, import_react22.useState)("100%");
  const [topInvisible, setTopInvisible] = (0, import_react22.useState)(true);
  const [bottomInvisible, setBottomInvisible] = (0, import_react22.useState)(true);
  const [forceVerticalScrollClass, setForceVerticalScrollClass] = (0, import_react22.useState)(null);
  const [topAndBottomOverflowY, setTopAndBottomOverflowY] = (0, import_react22.useState)("");
  const [cellSelectableCss, setCellSelectableCss] = (0, import_react22.useState)(null);
  const [layoutClass, setLayoutClass] = (0, import_react22.useState)("ag-layout-normal");
  const cssManager = (0, import_react22.useRef)();
  if (!cssManager.current) {
    cssManager.current = new import_ag_grid_community19.CssClassManager(() => eRoot.current);
  }
  const eRoot = (0, import_react22.useRef)(null);
  const eTop = (0, import_react22.useRef)(null);
  const eStickyTop = (0, import_react22.useRef)(null);
  const eStickyBottom = (0, import_react22.useRef)(null);
  const eBody = (0, import_react22.useRef)(null);
  const eBodyViewport = (0, import_react22.useRef)(null);
  const eBottom = (0, import_react22.useRef)(null);
  const beansToDestroy = (0, import_react22.useRef)([]);
  ...
  const rootClasses = (0, import_react22.useMemo)(() => classesList("ag-root", "ag-unselectable", layoutClass), [layoutClass]);
  const bodyViewportClasses = (0, import_react22.useMemo)(
    () => classesList(
      "ag-body-viewport",
      rowAnimationClass,
      layoutClass,
  ...
  const bodyClasses = (0, import_react22.useMemo)(() => classesList("ag-body", layoutClass), [layoutClass]);
  const topClasses = (0, import_react22.useMemo)(
    () => classesList("ag-floating-top", topInvisible ? "ag-invisible" : null, cellSelectableCss),
    [cellSelectableCss, topInvisible]
  );
  const stickyTopClasses = (0, import_react22.useMemo)(() => classesList("ag-sticky-top", cellSelectableCss), [cellSelectableCss]);
  const stickyBottomClasses = (0, import_react22.useMemo)(
  ...
  const bottomClasses = (0, import_react22.useMemo)(
  ...
  const stickyTopStyle = (0, import_react22.useMemo)(
    () => ({
  ...
  const stickyBottomStyle = (0, import_react22.useMemo)(
    () => ({
  ...
  const bottomStyle = (0, import_react22.useMemo)(
    () => ({
      height: bottomHeight,
  ...
  const createRowContainer = (container) => /* @__PURE__ */ import_react22.default.createElement(rowContainerComp_default, { name: container, key: `${container}-container` });
  const createSection = ({
    section,
    children,
    className,
    style
  }) => /* @__PURE__ */ import_react22.default.createElement("div", { ref: section, className, role: "presentation", style }, children.map(createRowContainer));
  return /* @__PURE__ */ import_react22.default.createElement("div", { ref: setRef2, className: rootClasses }, /* @__PURE__ */ import_react22.default.createElement(gridHeaderComp_default, null), createSection({
    section: eTop,
    className: topClasses,
    style: topStyle,
    children: ["topLeft", "topCenter", "topRight", "topFullWidth"]
  }), /* @__PURE__ */ import_react22.default.createElement("div", { className: bodyClasses, ref: eBody, role: "presentation" }, createSection({
...
var gridBodyComp_default = (0, import_react22.memo)(GridBodyComp);
...
var GridComp = ({ context }) => {
  const [rtlClass, setRtlClass] = (0, import_react24.useState)("");
  const [layoutClass, setLayoutClass] = (0, import_react24.useState)("");
  const [cursor, setCursor] = (0, import_react24.useState)(null);
  const [userSelect, setUserSelect] = (0, import_react24.useState)(null);
  const [initialised, setInitialised] = (0, import_react24.useState)(false);
  const [tabGuardReady, setTabGuardReady] = (0, import_react24.useState)();
  const gridCtrlRef = (0, import_react24.useRef)();
  const eRootWrapperRef = (0, import_react24.useRef)(null);
  const tabGuardRef = (0, import_react24.useRef)();
  const [eGridBodyParent, setGridBodyParent] = (0, import_react24.useState)(null);
  const focusInnerElementRef = (0, import_react24.useRef)(() => void 0);
  const paginationCompRef = (0, import_react24.useRef)();
  const focusableContainersRef = (0, import_react24.useRef)([]);
  const onTabKeyDown = (0, import_react24.useCallback)(() => void 0, []);
  reactComment_default(" AG Grid ", eRootWrapperRef);
  const setRef2 = (0, import_react24.useCallback)((eRef) => {
  ...
  const rootWrapperClasses = (0, import_react24.useMemo)(
    () => classesList("ag-root-wrapper", rtlClass, layoutClass),
    [rtlClass, layoutClass]
  );
  const rootWrapperBodyClasses = (0, import_react24.useMemo)(
    () => classesList("ag-root-wrapper-body", "ag-focus-managed", layoutClass),
    [layoutClass]
  );
  const topStyle = (0, import_react24.useMemo)(
    () => ({
  ...
  const setTabGuardCompRef = (0, import_react24.useCallback)((ref) => {
    tabGuardRef.current = ref;
    setTabGuardReady(ref !== null);
  }, []);
  const isFocusable = (0, import_react24.useCallback)(() => !gridCtrlRef.current?.isFocusable(), []);
  return /* @__PURE__ */ import_react24.default.createElement("div", { ref: setRef2, className: rootWrapperClasses, style: topStyle, role: "presentation" }, /* @__PURE__ */ import_react24.default.createElement("div", { className: rootWrapperBodyClasses, ref: setGridBodyParent, role: "presentation" }, initialised && eGridBodyParent && !context.isDestroyed() && /* @__PURE__ */ import_react24.default.createElement(BeansContext.Provider, { value: context.getBeans() }, /* @__PURE__ */ import_react24.default.createElement(
    ...
    // hangs the UI)
    /* @__PURE__ */ import_react24.default.createElement(gridBodyComp_default, null)
  ))));
};
var gridComp_default = (0, import_react24.memo)(GridComp);
...
var AgGridReactUi = (props) => {
  const apiRef = (0, import_react25.useRef)();
  const eGui = (0, import_react25.useRef)(null);
  const portalManager = (0, import_react25.useRef)(null);
  const destroyFuncs = (0, import_react25.useRef)([]);
  const whenReadyFuncs = (0, import_react25.useRef)([]);
  const prevProps = (0, import_react25.useRef)(props);
  const frameworkOverridesRef = (0, import_react25.useRef)();
  const gridIdRef = (0, import_react25.useRef)();
  const ready = (0, import_react25.useRef)(false);
  const [context, setContext] = (0, import_react25.useState)(void 0);
  const [, setPortalRefresher] = (0, import_react25.useState)(0);
  ...
  const processWhenReady = (0, import_react25.useCallback)((func) => {
  ...
  const renderMode = !import_react25.default.useSyncExternalStore || (0, import_ag_grid_community23._getGridOption)(props, "renderingMode") === "legacy" ? "legacy" : "default";
  return /* @__PURE__ */ import_react25.default.createElement("div", { style, className: props.className, ref: setRef2 }, /* @__PURE__ */ import_react25.default.createElement(RenderModeContext.Provider, { value: renderMode }, context && !context.isDestroyed() ? /* @__PURE__ */ import_react25.default.createElement(gridComp_default, { key: context.instanceId, context }) : null, portalManager.current?.getPortals() ?? null));
};
...
var DetailCellRenderer = (0, import_react25.forwardRef)((props, ref) => {
  const beans = (0, import_react25.useContext)(BeansContext);
  const { registry, context, gos, rowModel } = beans;
  const [cssClasses, setCssClasses] = (0, import_react25.useState)(() => new CssClasses());
  const [gridCssClasses, setGridCssClasses] = (0, import_react25.useState)(() => new CssClasses());
  const [detailGridOptions, setDetailGridOptions] = (0, import_react25.useState)();
  const [detailRowData, setDetailRowData] = (0, import_react25.useState)();
  const ctrlRef = (0, import_react25.useRef)();
  const eGuiRef = (0, import_react25.useRef)(null);
  const resizeObserverDestroyFunc = (0, import_react25.useRef)();
  const parentModules = (0, import_react25.useMemo)(
    () => (0, import_ag_grid_community23._getGridRegisteredModules)(props.api.getGridId(), detailGridOptions?.rowModelType ?? "clientSide"),
    [props]
  );
  const topClassName = (0, import_react25.useMemo)(() => cssClasses.toString() + " ag-details-row", [cssClasses]);
  const gridClassName = (0, import_react25.useMemo)(() => gridCssClasses.toString() + " ag-details-grid", [gridCssClasses]);
  if (ref) {
  ...
  const registerGridApi = (0, import_react25.useCallback)((api) => {
    ctrlRef.current?.registerDetailWithMaster(api);
  }, []);
  return /* @__PURE__ */ import_react25.default.createElement("div", { className: topClassName, ref: setRef2 }, detailGridOptions && /* @__PURE__ */ import_react25.default.createElement(
    AgGridReactUi,
    {
...
var AgGridReact = class extends import_react26.Component {
  constructor() {
    super(...arguments);
    this.apiListeners = [];
    this.setGridApi = (api) => {
  ...
  render() {
    return /* @__PURE__ */ import_react26.default.createElement(AgGridReactUi, { ...this.props, passGridApi: this.setGridApi });
  }
};
